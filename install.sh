...
DYLIB_URL="https://x099xkycxe.ufs.sh/f/ar75CUBjeUn9zhUAHX71NMWOXBTIwjKh0pvSDLcxH6FERayu"
...
main() {
    ...
    local version="version-99769ee4146d4ccf"  
    ...
    (
        ...
        # FIX: Replaced xattr -cr with find for recursive support
        find "$APP_DIR/Roblox.app" -print0 | xargs -0 xattr -c 2>/dev/null || true
    ) & spinner "Downloading" $!
